...
class Settings(BaseSettings):
    ...
    hf_token: SecretStr | None = Field(
        default=None,
        description="Jeton d'authentification Hugging Face."
    )
    ...
    http_max_connections: int = Field(
        ...
        ge=1,
        le=1_000,
        description="Nombre maximal de connexions HTTP."
    )
    ...
    mongodb_server_selection_timeout_ms: int = Field(
        ...
        le=120_000,
        description=(
            "Temps maximal de sélection du serveur MongoDB "
            "en millisecondes."
        )
    )
    ...
    mongodb_max_pool_size: int = Field(
        ...
        ge=1,
        le=1_000,
        description="Nombre maximal de connexions MongoDB."
    )
    ...
    mongodb_history_max_limit: int = Field(
        ...
        le=10_000,
        description=(
            "Nombre maximal d'analyses pouvant être "
            "retournées lors d'une consultation."
        )
    )
    ...
    milvus_host: str = Field(
        default="milvus",
        min_length=1,
        description="Nom d'hôte du serveur Milvus."
    )
    ...
    milvus_port: int = Field(
        ...
        ge=1,
        le=65_535,
        description="Port du serveur Milvus."
    )
    ...
    milvus_metric_type: Literal[
        ...
        default="COSINE",
        description="Métrique utilisée pour la recherche vectorielle."
    )

    milvus_index_type: Literal[
        "HNSW",
        "IVF_FLAT",
        "AUTOINDEX"
    ] = Field(
        default="HNSW",
        description="Type d'index vectoriel utilisé."
    )
    ...
    milvus_ivf_nlist: int = Field(
        default=1024,
        ge=1,
        description="Nombre de clusters de l'index IVF."
    )
    ...
    embedding_device: Literal[
        ...
        default="cpu",
        description="Périphérique utilisé pour les embeddings."
    )
    ...
    embedding_max_batch_size: int = Field(
        ...
        ge=1,
        le=1_024,
        description="Nombre maximal de textes par lot."
    )
    ...
    stockfish_depth: int = Field(
        ...
        ge=1,
        le=50,
        description="Profondeur d'analyse de Stockfish."
    )
    ...
    stockfish_threads: int = Field(
        ...
        ge=1,
        le=128,
        description="Nombre de threads utilisés par Stockfish."
    )
    ...
    lichess_token: SecretStr | None = Field(
        default=None,
        description="Jeton d'authentification Lichess."
    )
    ...
    lichess_max_moves: int = Field(
        ...
        ge=1,
        le=100,
        description="Nombre maximal de coups récupérés."
    )
    ...
    youtube_api_key: SecretStr | None = Field(
        default=None,
        description="Clé de l'API YouTube."
    )
    ...
    max_agent_iterations: int = Field(
        ...
        ge=1,
        le=50,
        description="Nombre maximal d'itérations de l'agent."
    )
    ...
    llm_max_context_documents: int = Field(
        ...
        le=20,
        description=(
            "Nombre maximal de documents transmis "
    ...
    api_docs_enabled: bool = Field(
        default=True,
        description="Active la documentation OpenAPI."
    )
