...
class Video(BaseModel):
    ...
    platform: VideoPlatform = VideoPlatform.YOUTUBE
...
class VideoSearchRequest(BaseModel):
    ...
    query: str = Field(
        ...,
        min_length=1,
        description=("Ouverture, position ou sujet échiquéen à rechercher."),
    )
    ...
    max_results: int | None = Field(
        default=None, ge=1, le=50, description=("Nombre maximal de vidéos à retourner.")
    )
    ...
    language: str | None = Field(
        ...
        min_length=2,
        max_length=10,
        description=("Langue privilégiée pour la recherche."),
    )
